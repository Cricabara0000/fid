...
En este apartado pondremos a prueba si se podría predecir el valor de la albumina en funcion de las variables existentes (sin la clase)
...
linearRegresion <- lm(sex ~ ., data = hepatitis_norm)
